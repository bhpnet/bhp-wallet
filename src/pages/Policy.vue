<template>
  <div class="main">
    ...
    <h4>《BHP Wallet隐私政策》</h4>
    尊敬的用户：
    <p></p>
   BHP Foundation.（以下简称“Foundation ”或“我们”）尊重并保护用户（以下简称“您”或“用户”）的隐私，当您进行以下行为时，BHP Foundation按照本隐私政策（以下简称“本政策”）收集、披露和处理您的个人信息：
    <p></p>
...
(b)向我们提供您的个人信息，无论通过何种媒介提供。
    <p></p>
    <p></p>
BHP Foundation建议您在使用应用之前仔细阅读并理解本政策全部内容, 针对免责声明等条款在内的重要信息将以加粗的形式体现。本政策有关关键词定义与BHP Foundation《BHP Wallet服务协议》保持一致。如果本政策中使用的定义或术语与《BHP Wallet服务协议》中的不一致，以本政策为准。
    <p></p>
您向我们提供您的个人信息，即代表您同意我们根据本政策的规定收集、使用、披露（包括传输）和处理您的个人信息。如您不接受本政策，请勿 向我们提供任何个人信息。
    <p></p>
本政策可由BHP Foundation在线随时更新，不另行通知。更新后的政策一经公布在我们的应用上即为生效，并代替原来的政策。修改后的政策将立刻适用于您向我们提供的个人信息。如果您不接受修改后的条款，请立即停止使用应用，您继续使用应用将被视为接受修改后的政策。
    <p></p>
一、我们收集您的哪些信息
    <p></p>
...
2.为满足您的特定服务需求，我们将收集您的个人信息，包括但不限于您的姓名、银行卡号、手机号码、邮件地址等信息。
    <p></p>
3.您知悉：您在应用上的钱包密码、私钥、助记词、Keystore并不存储或同步至BHP Foundation服务器。BHP Foundation不提供找回您的钱包密码、私钥、助记词、Keystore的服务。
    <p></p>
4.我们可能要求向您收集更多的个人信息，以使得您可以使用应用上的某些特定功能。如您不同意提供该等个人信息，则视为您放弃使用应用的特定功能。
    <p></p>
5.在法律法规允许的范围内，BHP Foundation可能会在以下情形中收集并使用您的个人信息，且无需征得您的授权同意：
    <p></p>
（1）与国家安全、国防安全有关的；
    <p></p>
...
（8）解决争议、调查任何投诉、索赔或争议、或任何实际或可以的非法行为；
    <p></p>
（9）进行BHP Foundation内部审计、数据分析和研究；
    <p></p>
...
3.您知悉，您及我们对于您交易记录是否公开并没有控制权，因为基于区块链交易系统的开源属性，您的交易记录在整个区块链系统中公开透明。
    <p></p>
4.我们的应用将包含链接，可链接至非由我们所有、运营、开发或维护的其他网站、应用或智能合约。这些链接系为您方便而提供。本政策仅适用于我们的应用。当您使用第三方服务时，您知悉，我们的《BHP Wallet服务协议》、《BHP Wallet隐私政策》将不再适用。我们建议您详细阅读并了解其隐私规则和有关用户服务协议等内容。
    <p></p>
5.您有权要求我们更新、更改、删除您的个人信息和/或撤回您给予我们的同意。如果您希望撤回您曾给予我们的同意，或如您希望更新、更改、删除或访问我们持有的个人信息，或您不接受我们对于本政策的修改，您可以联系：
    <p></p>
姓名：BHP Wallet
    <p></p>
邮件地址：support@bhpa.io
    <p></p>
...
5.如果为了上述的目的，我们需要将您的个人信息传输至任何其他国家，我们将获得您的同意，并且确保个人信息的接收方具备和我们同等级的个人信息保护措施。如果该等国家或地区尚无可适用于我们与您之间关系的个人信息保护法律，我们将与个人信息接收方签订可合法执行的协议。
    <p></p>
6.未经您事先同意，BHP Foundation不会将您的个人信息向任何第三方共享或转让，但以下情况除外：
    <p></p>
...
（3）根据适用的法律法规、法律程序的要求、行政机关或司法机关的要求进行提供或执行本政策以保护我们或其他方的权利、财产或安全；
    <p></p>
（4）在涉及合并、收购时，如涉及到个人信息转让，BHP Foundation将要求个人信息接收方继续接受本政策的约束。
    <p></p>
五、自动数据收集技术
    <p></p>
...
六、我们如何保护您的信息
    <p></p>
1.如BHP Foundation停止运营，BHP Foundation将停止继续收集您个人信息的活动，并采取措施对所持有的您的个人信息在合理期限内进行删除或匿名化处理。
    <p></p>
2.为了保护您的个人信息，BHP Foundation将采取数据安全技术措施，提升内部合规水平，增加内部员工信息安全培训，并对相关数据设置安全访问权限等方式安全保护您的隐私信息。
    <p></p>
七、对未成年人的保护
    <p></p>
我们对保护未满18周岁的未成年人做出如下特别约定：
    <p></p>
1.未成年人应当在父母或监护人指导下使用BHP Foundation相关服务。
    <p></p>
2.我们建议未成年人的父母和监护人应当在阅读本政策、《BHP Wallet服务协议》及我们的其他有关规则的前提下，指导未成年人使用应用。
    <p></p>
3.本应用将根据适用的法律法规的规定保护未成年人的个人信息的保密性及安全性。
    <p></p>
八、免责声明
    <p></p>
1.您确认，您使用第三方服务之后，本政策将不再适用于该等第三方对您个人信息的收集、使用、披露和传输行为。BHP Foundation无法保证该等第三方会采取合理的安全保护措施。
    <p></p>
2.您将自行对使用第三方服务的行为承担责任，并且您同意，如第三方收集、使用、披露和传输您个人信息，导致您受到损失或损害的，您不得要求BHP Foundation承担责任。
    <p></p>
3. 您确认并接受，在适用的法律允许的最大限度下，BHP Foundation将在现有技术水平条件下，基于“根据现状”、“根据可用”、“不保证无瑕疵”的原则，尽可能采取合理的安全措施保护您的个人信息，以避免信息的泄露、篡改或者毁损。BHP Foundation系利用无线方式传输数据，因此，BHP Foundation无法确保通过无线网络传输数据的隐私性和安全性。
    <p></p>
九、其他
    <p></p>
1.您需全面了解并遵守您所在司法辖区与使用BHP Foundation服务所有相关法律、法规及规则。
    <p></p>
2.法律适用和争议解决：
    <p></p>
...
（2）因本政策引起的或与之相关的任何争议（包括任何有关其存在、有效性、终止的问题），双方应首先寻求和解。如果该争议在该和解程序开始后的30天内仍未解决，双方应将该争议提交至新加坡国际仲裁中心（简称“SIAC”），并通过遵循新加坡国际仲裁中心届时有效的仲裁规则（该规则被视为通过引用并入本条款），最终以仲裁的方式在新加坡予以解决。仲裁庭由一名仲裁员组成，由SIAC主席任命。仲裁语言为英语。每一方不可撤销地接受新加坡法院之非专属管辖权，以支持和协助根据本段前述内容进行的仲裁程序，包括在该程序的结果作出之前给予临时救济（如必要）。
    <p></p>
3.您可以在我们的应用中查看本政策及BHP Foundation其他服务规则。我们鼓励您在每次访问应用时都查阅BHP Foundation的服务协议及隐私政策。
    <p></p>
4.本政策的任何译文版本仅为方便用户而提供，无意对本政策的条款进行修改。如果本政策的英文版本与非英文版本之间存在冲突，应以英文版本为准。
    <p></p>
5.本政策自2020年08月27日起适用。
    <p></p>
本政策未尽事宜，您需遵守BHP Foundation不时更新的公告及相关规则。
